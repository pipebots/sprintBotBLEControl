...
For the most part this was avoided, but it was decided to 3D print the gears rather than use the machined ones that wer
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDIwMTc5MTgsLTIxMjkxMjU3MDQsMT
