...
Mainly used for debugging. In testing with T4 it was discovered that this method caused problems when communicating with the Raspberry Pi so a simpler format was used to decrease the amount of data being transfered. These are called **readCom() & sendCOM()**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyMDYyOTQwNywtODIzMjEyMjMsLTE5OD
