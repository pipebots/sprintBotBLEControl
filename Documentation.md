...
If the robot is driven up the side of the pipe, especially when going round a bend or endering a p
### Tyre Flexibility
...
The pi and arduino can fit together with the lid closed, the Red Pitaya would not as well, but the Pi was not needed at the same time. It is possible that making some of the wires longer would help as the position of the boards would be less constrained. 


# Sprint Lessons Learnt 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3NzY5ODc0NiwtMTc4NzY1MDEwLC05MT
