...
For the most part this was avoided, but it was decided to 3D print the gears rather than use the machined ones that were ordered as this gave a much greater flexibility in design and considerablly reduced the weight. The large ring gears 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDg2MTA5ODgyLC0yMTI5MTI1NzA0LDExOT
