...
This theme wanted to mount 5 x VL53L0X Time-of-Flight Distance Sensors and ran their code on the Raspberry Pi. In the origional sprint plan the plan seemed to have been to output directly to the motor drivers using PWM and Direction pins. Due to the extra development that T3 was able to do, including having a PID control and other aspects o
# Software
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTc4NzM2MTYsMTkwMDA4MTgwMCw1OT
IyODYzODgsMTM0MzA2NTU3MywtMTkwMTIzOTMwOCwxNzgzMTE1
NDIsLTczODU0MDAzMiw5ODQ5MjI2OTMsNDY4MDEyOTA5LC01MD
